...
import adress from './../image/Location.svg'
...
const SideBarMobile = () => {
  ...
  return (
    <div className="account__block-options-for-user-mobile">
              ...
              <div className='account__block-option-user-inside'>
                <div className='account__block-options'>
                  ...
                  <NavLink className={({isActive}) => {
                    return isActive ? commonPage : activePage
                  }} to='/AddAdress'><div className="account__block-list-item-inside">
                    <img className="account__icons-option" src={adress} alt="" />
                  ...
                  <NavLink className={({isActive}) => {
                    return isActive ? commonPage : activePage
                  }} to='/WishList'><div className="account__block-list-item-inside">
                  ...
                  <li className="account__list-item-options"><NavLink className={({isActive}) => {
                    return isActive ? commonPage : activePage

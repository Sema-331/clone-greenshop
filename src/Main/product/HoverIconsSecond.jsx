...
import { handleHoverOptions, onclickHnadleEyes, closeEaysModal, handleClickRecentlyViews, handelClickRemoveProductFavourites, handleClickAddFavourites, handleClickAddBasketProduct, handleClickConfirmProductModal, handleClickRemoveFavourites, handleTOggle, toggleStatus, fetchQuery } from '../../Slices/SliceProducts';
  ...
  return (
      ...
      >
        <div className='product__block__icons-animation'>
          ...
          <svg onClick={handleClickAddProductBasket} className='svg__animation' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    {/*<FavouritesIcons item={item} />*/}
      <svg className='svg__animation svg__animation-search' onClick={() => handleClickModal(item.id)} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    {
      log ? <LoginFormMain confirmProductAdd={confirmProductAdd} setConfirmProductAdd={setConfirmProductAdd} item={item} log={log} setLog={setLog} login={login} setLogin={setLogin} />: null
    }
...
export default HoverIconsSecond